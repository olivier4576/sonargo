...
[![GoDoc](https://godoc.org/github.com/olivier4576/sonargo/sonar?status.svg)](https://godoc.org/github.com/olivier4576/sonargo/sonar)
...
```go
import github.com/olivier4576/sonargo/sonar
```
...
- Sonarqube community does not build a v7.4 docker image for public, so a v7.4 dockerfile is provided in [build](https://github.com/olivier4576/sonargo/tree/master/build) folder.
